...
class _MapEditorPageState extends State<MapEditorPage> {
  ...
  void _zoomBy(double factor) {
    setState(() {
      ...
      _viewerController.value = Matrix4.identity()..scaleByDouble(
        _zoom,
        _zoom,
        _zoom,
        1,
  ...
  void _updateEnvironment(EnvironmentSettings Function(EnvironmentSettings) update) {
  ...
  void _addKeyframe() {
    ...
    _updateEnvironment(
      (env) => env.copyWith(
        timeline: [...timeline, WeatherKeyframe(atProgress: nextProgress)],
      ),
    );
  }
                    ...
                    child: Padding(
                      ...
                      child: LayoutBuilder(
                        builder: (context, constraints) {
                          final aspect =
                              _draft.arenaWidth / _draft.arenaHeight;
                ...
                child: ListView(
                  ...
                  if (_tool == _EditorTool.river) ...[
                    ...
                    Slider(
                      ...
                      min: 16,
                      max: 160,
                      onChanged: (value) => setState(() => _riverWidth = value),
                    ),
                  ],
                  ...
                  Slider(
                    ...
                    onChanged: (value) =>
                        _updateEnvironment((env) => env.copyWith(sunAngle: value)),
                  ),
                  const SizedBox(height: 8),
                  Text(
                  ...
                  for (final (index, keyframe)
                    ...
                    _WeatherKeyframeEditor(
                      keyframe: keyframe,
                      onChanged: (updated) => _replaceKeyframe(index, updated),
