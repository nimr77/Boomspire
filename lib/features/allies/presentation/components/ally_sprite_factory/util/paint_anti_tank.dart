...
/// Paints the friendly anti-tank soldier "2D object model" - a
/// shoulder-mounted rocket tube, sharing the home base's cyan livery.
void paintAntiTank(Canvas canvas) {
  const size = 48.0;
