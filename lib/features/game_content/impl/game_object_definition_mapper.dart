...
GameObjectDefinition? findOverride(List<GameObjectDefinition> overrides, String id) {
...
UnitBlueprint applyTowerOverride(UnitBlueprint base, GameObjectDefinition override) =>
    UnitBlueprint(
      type: base.type,
      name: base.name,
      cost: override.cost,
...
UnitBlueprint applyBuildingOverride(UnitBlueprint base, GameObjectDefinition override) =>
    UnitBlueprint(
      type: base.type,
      name: base.name,
      cost: override.cost,
